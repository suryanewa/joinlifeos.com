	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				"pulse-glow": {
					"0%, 100%": {
						transform: "scale(1)",
						boxShadow:
							"0 0 20px rgba(87, 6, 140, 0.6), 0 0 40px rgba(87, 6, 140, 0.4), 0 0 60px rgba(87, 6, 140, 0.2)",
					},
					"50%": {
						transform: "scale(1.1)",
						boxShadow:
							"0 0 30px rgba(87, 6, 140, 0.8), 0 0 60px rgba(87, 6, 140, 0.6), 0 0 90px rgba(87, 6, 140, 0.4)",
					},
				},
				"pulse-ring": {
					"0%": {
			...
			animation: {
				...
				"pulse-wide": "pulse-wide 3s ease-out infinite",
				"pulse-text-glow": "pulse-text-glow 4s ease-in-out infinite",
				"lock-float": "lock-float 3s ease-in-out infinite",
			},
		},
	},
	plugins: [
