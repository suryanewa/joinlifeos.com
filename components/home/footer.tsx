				...
				<AnimationContainer delay={0.1}>
					<div className="flex flex-col items-start justify-start md:max-w-[200px]">
						...
						<p className="mt-4 text-start text-muted-foreground text-sm">
							The operating system for your life. Organize everything in one
							place.
						</p>
						<div className="flex items-center gap-1 pt-2 text-muted-foreground">
							<Link
								href="https://github.com/organizations/joinlifeos"
								target="_blank"
							>
								<Github className="size-4 hover:text-white" />
							</Link>
							<Link
								href="https://www.linkedin.com/company/joinlifeos"
								target="_blank"
							>
